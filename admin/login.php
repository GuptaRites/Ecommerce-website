...
if(isset($_POST['lgn_btn'])){
    ...
    $q ="SELECT userId,Password FROM admin WHERE userId = '$uid'";
    ...
    <div class="box">
        <form id="login" action="login.php" method="POST">
            <div class="login">
                ...
                <input type="text" name="id" class="inp-1" id="user" placeholder="Enter Your User ID" required><br>
                <label>Password</label>
                <span id="passwordError" class="error"></span>
                <input type="password" name="pswd" class="inp-1" id="password" placeholder="Enter Your Password" required><br><br>
